...
![demo](https://github.com/NativeScript/nativescript-app-template/blob/master/packages/template-enterprise-auth-ts/tools/assets/enterprise-auth-preview.gif?raw=true)
...
- `app/home/home-page.ts` - The home page of the app - provides a Login button which, when clicked, takes the user through the configured login process.
