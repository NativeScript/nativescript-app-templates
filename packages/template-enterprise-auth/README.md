...
# NativeScript Enterprise Auth Template
...
### Kinvey integration
The templates uses the [{N} Kinvey plugin](https://github.com/Kinvey/nativescript-sdk). The initialization is done before the app starts in the `/main.js` file. The initialization script is located at `/shared/kinvey.common.js`.
...
If you have found an issue with this template, please report the problem in the   [Issues](https://github.com/NativeScript/template-enterprise-auth/issues).
